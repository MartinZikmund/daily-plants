#!/bin/zsh
# Renders slides.html into artifacts/store/ios/images/iphone/<N>.png and .../ipad/<N>.png with headless Edge or Chrome.
...
here=${0:A:h}
images=${here:h:h:h:h}/artifacts/store/ios/images
browser=${BROWSER:-}
